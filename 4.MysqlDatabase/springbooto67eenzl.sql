/*
 ...
 Source Schema         : springbooto67eenzl

 Target Server Type    : MySQL
 Target Server Version : 80041 (8.0.41)
 File Encoding         : 65001

 Date: 14/02/2026 17:52:15
*/
...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (1, '2024-03-07 14:29:54', 11, '宇宙银河系金星1号', '金某', '13823888881', '是');
INSERT INTO `address` VALUES (2, '2024-03-07 14:29:54', 12, '宇宙银河系木星1号', '木某', '13823888882', '是');
INSERT INTO `address` VALUES (3, '2024-03-07 14:29:54', 13, '宇宙银河系水星1号', '水某', '13823888883', '是');
INSERT INTO `address` VALUES (4, '2024-03-07 14:29:54', 14, '宇宙银河系火星1号', '火某', '13823888884', '是');
INSERT INTO `address` VALUES (5, '2024-03-07 14:29:54', 15, '宇宙银河系土星1号', '土某', '13823888885', '是');
INSERT INTO `address` VALUES (6, '2024-03-07 14:29:54', 16, '宇宙银河系月球1号', '月某', '13823888886', '是');
INSERT INTO `address` VALUES (7, '2024-03-07 14:29:54', 17, '宇宙银河系黑洞1号', '黑某', '13823888887', '是');
INSERT INTO `address` VALUES (8, '2024-03-07 14:29:54', 18, '宇宙银河系地球1号', '地某', '13823888888', '是');
...
CREATE TABLE `cart`  (
  ...
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商户名称',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (71, '2024-03-07 14:29:54', 1, 1, '提问1', '回复1', 1);
INSERT INTO `chat` VALUES (72, '2024-03-07 14:29:54', 2, 2, '提问2', '回复2', 2);
INSERT INTO `chat` VALUES (73, '2024-03-07 14:29:54', 3, 3, '提问3', '回复3', 3);
INSERT INTO `chat` VALUES (74, '2024-03-07 14:29:54', 4, 4, '提问4', '回复4', 4);
INSERT INTO `chat` VALUES (75, '2024-03-07 14:29:54', 5, 5, '提问5', '回复5', 5);
INSERT INTO `chat` VALUES (76, '2024-03-07 14:29:54', 6, 6, '提问6', '回复6', 6);
INSERT INTO `chat` VALUES (77, '2024-03-07 14:29:54', 7, 7, '提问7', '回复7', 7);
INSERT INTO `chat` VALUES (78, '2024-03-07 14:29:54', 8, 8, '提问8', '回复8', 8);

-- ----------------------------
-- Table structure for choujianghuodong
-- ----------------------------
DROP TABLE IF EXISTS `choujianghuodong`;
CREATE TABLE `choujianghuodong`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `huodongkaishishijian` datetime NULL DEFAULT NULL COMMENT '活动开始时间',
  `huodongjieshushijian` datetime NULL DEFAULT NULL COMMENT '活动结束时间',
  `jiangxiangshezhi` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '奖项设置',
  `huodongjieshao` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '活动介绍',
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺名称',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `huodongbianhao`(`huodongbianhao` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '抽奖活动' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of choujianghuodong
-- ----------------------------
INSERT INTO `choujianghuodong` VALUES (51, '2024-03-07 14:29:54', '1111111111', '活动名称1', '活动1', 'upload/choujianghuodong_tupian1.jpg,upload/choujianghuodong_tupian2.jpg,upload/choujianghuodong_tupian3.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置1', '活动介绍1', '店铺名称1');
INSERT INTO `choujianghuodong` VALUES (52, '2024-03-07 14:29:54', '2222222222', '活动名称2', '活动1', 'upload/choujianghuodong_tupian2.jpg,upload/choujianghuodong_tupian3.jpg,upload/choujianghuodong_tupian4.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置2', '活动介绍2', '店铺名称2');
INSERT INTO `choujianghuodong` VALUES (53, '2024-03-07 14:29:54', '3333333333', '活动名称3', '活动1', 'upload/choujianghuodong_tupian3.jpg,upload/choujianghuodong_tupian4.jpg,upload/choujianghuodong_tupian5.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置3', '活动介绍3', '店铺名称3');
INSERT INTO `choujianghuodong` VALUES (54, '2024-03-07 14:29:54', '4444444444', '活动名称4', '活动1', 'upload/choujianghuodong_tupian4.jpg,upload/choujianghuodong_tupian5.jpg,upload/choujianghuodong_tupian6.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置4', '活动介绍4', '店铺名称4');
INSERT INTO `choujianghuodong` VALUES (55, '2024-03-07 14:29:54', '5555555555', '活动名称5', '活动1', 'upload/choujianghuodong_tupian5.jpg,upload/choujianghuodong_tupian6.jpg,upload/choujianghuodong_tupian7.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置5', '活动介绍5', '店铺名称5');
INSERT INTO `choujianghuodong` VALUES (56, '2024-03-07 14:29:54', '6666666666', '活动名称6', '活动1', 'upload/choujianghuodong_tupian6.jpg,upload/choujianghuodong_tupian7.jpg,upload/choujianghuodong_tupian8.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置6', '活动介绍6', '店铺名称6');
INSERT INTO `choujianghuodong` VALUES (57, '2024-03-07 14:29:54', '7777777777', '活动名称7', '活动1', 'upload/choujianghuodong_tupian7.jpg,upload/choujianghuodong_tupian8.jpg,upload/choujianghuodong_tupian9.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置7', '活动介绍7', '店铺名称7');
INSERT INTO `choujianghuodong` VALUES (58, '2024-03-07 14:29:54', '8888888888', '活动名称8', '活动1', 'upload/choujianghuodong_tupian8.jpg,upload/choujianghuodong_tupian9.jpg,upload/choujianghuodong_tupian10.jpg', '启用', '2024-03-07 14:29:54', '2024-03-07 14:29:54', '奖项设置8', '活动介绍8', '店铺名称8');

-- ----------------------------
-- Table structure for choujiangjilu
-- ----------------------------
DROP TABLE IF EXISTS `choujiangjilu`;
CREATE TABLE `choujiangjilu`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `huodongbianhao` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动编号',
  `huodongmingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动名称',
  `huodongleixing` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动类型',
  `tupian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '图片',
  `shifouzhongjiang` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否中奖',
  `jiangpinmingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '奖品名称',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 69 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '抽奖记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of choujiangjilu
-- ----------------------------
INSERT INTO `choujiangjilu` VALUES (61, '2024-03-07 14:29:54', '活动编号1', '活动名称1', '活动类型1', 'upload/choujiangjilu_tupian1.jpg,upload/choujiangjilu_tupian2.jpg,upload/choujiangjilu_tupian3.jpg', '是否中奖1', '奖品名称1', '用户账号1', '用户姓名1', '店铺名称1', 1, 1);
INSERT INTO `choujiangjilu` VALUES (62, '2024-03-07 14:29:54', '活动编号2', '活动名称2', '活动类型2', 'upload/choujiangjilu_tupian2.jpg,upload/choujiangjilu_tupian3.jpg,upload/choujiangjilu_tupian4.jpg', '是否中奖2', '奖品名称2', '用户账号2', '用户姓名2', '店铺名称2', 2, 2);
INSERT INTO `choujiangjilu` VALUES (63, '2024-03-07 14:29:54', '活动编号3', '活动名称3', '活动类型3', 'upload/choujiangjilu_tupian3.jpg,upload/choujiangjilu_tupian4.jpg,upload/choujiangjilu_tupian5.jpg', '是否中奖3', '奖品名称3', '用户账号3', '用户姓名3', '店铺名称3', 3, 3);
INSERT INTO `choujiangjilu` VALUES (64, '2024-03-07 14:29:54', '活动编号4', '活动名称4', '活动类型4', 'upload/choujiangjilu_tupian4.jpg,upload/choujiangjilu_tupian5.jpg,upload/choujiangjilu_tupian6.jpg', '是否中奖4', '奖品名称4', '用户账号4', '用户姓名4', '店铺名称4', 4, 4);
INSERT INTO `choujiangjilu` VALUES (65, '2024-03-07 14:29:54', '活动编号5', '活动名称5', '活动类型5', 'upload/choujiangjilu_tupian5.jpg,upload/choujiangjilu_tupian6.jpg,upload/choujiangjilu_tupian7.jpg', '是否中奖5', '奖品名称5', '用户账号5', '用户姓名5', '店铺名称5', 5, 5);
INSERT INTO `choujiangjilu` VALUES (66, '2024-03-07 14:29:54', '活动编号6', '活动名称6', '活动类型6', 'upload/choujiangjilu_tupian6.jpg,upload/choujiangjilu_tupian7.jpg,upload/choujiangjilu_tupian8.jpg', '是否中奖6', '奖品名称6', '用户账号6', '用户姓名6', '店铺名称6', 6, 6);
INSERT INTO `choujiangjilu` VALUES (67, '2024-03-07 14:29:54', '活动编号7', '活动名称7', '活动类型7', 'upload/choujiangjilu_tupian7.jpg,upload/choujiangjilu_tupian8.jpg,upload/choujiangjilu_tupian9.jpg', '是否中奖7', '奖品名称7', '用户账号7', '用户姓名7', '店铺名称7', 7, 7);
INSERT INTO `choujiangjilu` VALUES (68, '2024-03-07 14:29:54', '活动编号8', '活动名称8', '活动类型8', 'upload/choujiangjilu_tupian8.jpg,upload/choujiangjilu_tupian9.jpg,upload/choujiangjilu_tupian10.jpg', '是否中奖8', '奖品名称8', '用户账号8', '用户姓名8', '店铺名称8', 8, 8);
...
CREATE TABLE `coupon`  (
  ...
  `type` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '券类型',
  ...
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商户名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠券' ROW_FORMAT = Dynamic;
...
CREATE TABLE `discussshangpinxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品信息评论表' ROW_FORMAT = Dynamic;
...
-- Records of forum
-- ----------------------------
INSERT INTO `forum` VALUES (81, '2024-03-07 14:29:54', '帖子标题1', '帖子内容1', 0, 1, '用户名1', 'upload/forum_avatarurl1.jpg,upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (82, '2024-03-07 14:29:54', '帖子标题2', '帖子内容2', 0, 2, '用户名2', 'upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (83, '2024-03-07 14:29:54', '帖子标题3', '帖子内容3', 0, 3, '用户名3', 'upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (84, '2024-03-07 14:29:54', '帖子标题4', '帖子内容4', 0, 4, '用户名4', 'upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (85, '2024-03-07 14:29:54', '帖子标题5', '帖子内容5', 0, 5, '用户名5', 'upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (86, '2024-03-07 14:29:54', '帖子标题6', '帖子内容6', 0, 6, '用户名6', 'upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (87, '2024-03-07 14:29:54', '帖子标题7', '帖子内容7', 0, 7, '用户名7', 'upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg', '开放', 0, '2024-03-07 14:29:54');
INSERT INTO `forum` VALUES (88, '2024-03-07 14:29:54', '帖子标题8', '帖子内容8', 0, 8, '用户名8', 'upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg,upload/forum_avatarurl10.jpg', '开放', 0, '2024-03-07 14:29:54');
...
CREATE TABLE `mycoupon`  (
  ...
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '名称',
  `couponnumber` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '券编号',
  `fullamount` double NOT NULL DEFAULT 0 COMMENT '满额',
  `discountamount` double NOT NULL DEFAULT 0 COMMENT '优惠额',
  `startime` datetime NULL DEFAULT NULL COMMENT '生效时间',
  `endtime` datetime NULL DEFAULT NULL COMMENT '过期时间',
  `type` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '优惠券类型',
  `remark` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `status` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '状态',
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商户名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '我的优惠券' ROW_FORMAT = Dynamic;
...
CREATE TABLE `newstype`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 149 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告信息分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of newstype
-- ----------------------------
INSERT INTO `newstype` VALUES (141, '2024-03-07 14:29:54', '分类名称1');
INSERT INTO `newstype` VALUES (142, '2024-03-07 14:29:54', '分类名称2');
INSERT INTO `newstype` VALUES (143, '2024-03-07 14:29:54', '分类名称3');
INSERT INTO `newstype` VALUES (144, '2024-03-07 14:29:54', '分类名称4');
INSERT INTO `newstype` VALUES (145, '2024-03-07 14:29:54', '分类名称5');
INSERT INTO `newstype` VALUES (146, '2024-03-07 14:29:54', '分类名称6');
INSERT INTO `newstype` VALUES (147, '2024-03-07 14:29:54', '分类名称7');
INSERT INTO `newstype` VALUES (148, '2024-03-07 14:29:54', '分类名称8');
...
CREATE TABLE `orders`  (
  ...
  `couponnumber` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '券编号',
  `discountamount` double NULL DEFAULT 0 COMMENT '优惠额',
  `orderno` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '统一订单编号',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `shangjia`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺名称',
  `mima` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '密码',
  `dianpudizhi` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '店铺地址',
  ...
  `dianpujianjie` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '店铺简介',
  `dianpuzhaopian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '店铺照片',
...
-- Records of shangjia
-- ----------------------------
INSERT INTO `shangjia` VALUES (21, '2024-03-07 14:29:54', '店铺名称1', '123456', '店铺地址1', '经营范围1', '营业时间1', '13823888881', '', '店铺简介1', 'upload/shangjia_dianpuzhaopian1.jpg', '是', '', 1, 200);
INSERT INTO `shangjia` VALUES (22, '2024-03-07 14:29:54', '店铺名称2', '123456', '店铺地址2', '经营范围2', '营业时间2', '13823888882', '', '店铺简介2', 'upload/shangjia_dianpuzhaopian2.jpg', '是', '', 2, 200);
INSERT INTO `shangjia` VALUES (23, '2024-03-07 14:29:54', '店铺名称3', '123456', '店铺地址3', '经营范围3', '营业时间3', '13823888883', '', '店铺简介3', 'upload/shangjia_dianpuzhaopian3.jpg', '是', '', 3, 200);
INSERT INTO `shangjia` VALUES (24, '2024-03-07 14:29:54', '店铺名称4', '123456', '店铺地址4', '经营范围4', '营业时间4', '13823888884', '', '店铺简介4', 'upload/shangjia_dianpuzhaopian4.jpg', '是', '', 4, 200);
INSERT INTO `shangjia` VALUES (25, '2024-03-07 14:29:54', '店铺名称5', '123456', '店铺地址5', '经营范围5', '营业时间5', '13823888885', '', '店铺简介5', 'upload/shangjia_dianpuzhaopian5.jpg', '是', '', 5, 200);
INSERT INTO `shangjia` VALUES (26, '2024-03-07 14:29:54', '店铺名称6', '123456', '店铺地址6', '经营范围6', '营业时间6', '13823888886', '', '店铺简介6', 'upload/shangjia_dianpuzhaopian6.jpg', '是', '', 6, 200);
INSERT INTO `shangjia` VALUES (27, '2024-03-07 14:29:54', '店铺名称7', '123456', '店铺地址7', '经营范围7', '营业时间7', '13823888887', '', '店铺简介7', 'upload/shangjia_dianpuzhaopian7.jpg', '是', '', 7, 200);
INSERT INTO `shangjia` VALUES (28, '2024-03-07 14:29:54', '店铺名称8', '123456', '店铺地址8', '经营范围8', '营业时间8', '13823888888', '', '店铺简介8', 'upload/shangjia_dianpuzhaopian8.jpg', '是', '', 8, 200);
...
CREATE TABLE `shangpinleixing`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品类型' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of shangpinleixing
-- ----------------------------
INSERT INTO `shangpinleixing` VALUES (41, '2024-03-07 14:29:54', '商品类型1');
INSERT INTO `shangpinleixing` VALUES (42, '2024-03-07 14:29:54', '商品类型2');
INSERT INTO `shangpinleixing` VALUES (43, '2024-03-07 14:29:54', '商品类型3');
INSERT INTO `shangpinleixing` VALUES (44, '2024-03-07 14:29:54', '商品类型4');
INSERT INTO `shangpinleixing` VALUES (45, '2024-03-07 14:29:54', '商品类型5');
INSERT INTO `shangpinleixing` VALUES (46, '2024-03-07 14:29:54', '商品类型6');
INSERT INTO `shangpinleixing` VALUES (47, '2024-03-07 14:29:54', '商品类型7');
INSERT INTO `shangpinleixing` VALUES (48, '2024-03-07 14:29:54', '商品类型8');
...
CREATE TABLE `shangpinxinxi`  (
  ...
  `shengchanchangjia` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生产厂家',
  ...
  `shangpintupian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '商品图片',
  `dianpumingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺名称',
  ...
  `storeupnum` int NULL DEFAULT 0 COMMENT '收藏数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of shangpinxinxi
-- ----------------------------
INSERT INTO `shangpinxinxi` VALUES (31, '2024-03-07 14:29:54', '商品名称1', '商品类型1', '品牌1', '规格1', '生产厂家1', '2024-03-07', '商品介绍1', 'upload/shangpinxinxi_shangpintupian1.jpg,upload/shangpinxinxi_shangpintupian2.jpg,upload/shangpinxinxi_shangpintupian3.jpg', '店铺名称1', 1, 99, 1, 1, '2024-03-07 14:29:54', 1, 0, 99.9, 1);
INSERT INTO `shangpinxinxi` VALUES (32, '2024-03-07 14:29:54', '商品名称2', '商品类型2', '品牌2', '规格2', '生产厂家2', '2024-03-07', '商品介绍2', 'upload/shangpinxinxi_shangpintupian2.jpg,upload/shangpinxinxi_shangpintupian3.jpg,upload/shangpinxinxi_shangpintupian4.jpg', '店铺名称2', 2, 99, 2, 2, '2024-03-07 14:29:54', 2, 0, 99.9, 2);
INSERT INTO `shangpinxinxi` VALUES (33, '2024-03-07 14:29:54', '商品名称3', '商品类型3', '品牌3', '规格3', '生产厂家3', '2024-03-07', '商品介绍3', 'upload/shangpinxinxi_shangpintupian3.jpg,upload/shangpinxinxi_shangpintupian4.jpg,upload/shangpinxinxi_shangpintupian5.jpg', '店铺名称3', 3, 99, 3, 3, '2024-03-07 14:29:54', 3, 0, 99.9, 3);
INSERT INTO `shangpinxinxi` VALUES (34, '2024-03-07 14:29:54', '商品名称4', '商品类型4', '品牌4', '规格4', '生产厂家4', '2024-03-07', '商品介绍4', 'upload/shangpinxinxi_shangpintupian4.jpg,upload/shangpinxinxi_shangpintupian5.jpg,upload/shangpinxinxi_shangpintupian6.jpg', '店铺名称4', 4, 99, 4, 4, '2024-03-07 14:29:54', 4, 0, 99.9, 4);
INSERT INTO `shangpinxinxi` VALUES (35, '2024-03-07 14:29:54', '商品名称5', '商品类型5', '品牌5', '规格5', '生产厂家5', '2024-03-07', '商品介绍5', 'upload/shangpinxinxi_shangpintupian5.jpg,upload/shangpinxinxi_shangpintupian6.jpg,upload/shangpinxinxi_shangpintupian7.jpg', '店铺名称5', 5, 99, 5, 5, '2024-03-07 14:29:54', 5, 0, 99.9, 5);
INSERT INTO `shangpinxinxi` VALUES (36, '2024-03-07 14:29:54', '商品名称6', '商品类型6', '品牌6', '规格6', '生产厂家6', '2024-03-07', '商品介绍6', 'upload/shangpinxinxi_shangpintupian6.jpg,upload/shangpinxinxi_shangpintupian7.jpg,upload/shangpinxinxi_shangpintupian8.jpg', '店铺名称6', 6, 99, 6, 6, '2024-03-07 14:29:54', 6, 0, 99.9, 6);
INSERT INTO `shangpinxinxi` VALUES (37, '2024-03-07 14:29:54', '商品名称7', '商品类型7', '品牌7', '规格7', '生产厂家7', '2024-03-07', '商品介绍7', 'upload/shangpinxinxi_shangpintupian7.jpg,upload/shangpinxinxi_shangpintupian8.jpg,upload/shangpinxinxi_shangpintupian9.jpg', '店铺名称7', 7, 99, 7, 7, '2024-03-07 14:29:54', 8, 0, 99.9, 7);
INSERT INTO `shangpinxinxi` VALUES (38, '2024-03-07 14:29:54', '商品名称8', '商品类型8', '品牌8', '规格8', '生产厂家8', '2024-03-07', '商品介绍8', 'upload/shangpinxinxi_shangpintupian8.jpg,upload/shangpinxinxi_shangpintupian9.jpg,upload/shangpinxinxi_shangpintupian10.jpg', '店铺名称8', 8, 99, 8, 8, '2024-03-07 14:29:54', 10, 0, 99.9, 8);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 11, '用户账号1', 'yonghu', '用户', 'qzszvzdbtzqvv4mb7dewr7iyh8xte5wn', '2024-03-07 14:32:16', '2024-03-07 15:32:17');
INSERT INTO `token` VALUES (2, 1, 'admin', 'users', '管理员', 'j2miy26mc5ibf07q9vjq35sjqcbxbokg', '2026-02-14 17:39:54', '2026-02-14 18:41:16');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', 'admin', 'upload/image1.jpg', '管理员', '2024-03-07 14:29:54');
...
-- Records of yonghu
-- ----------------------------
INSERT INTO `yonghu` VALUES (11, '2024-03-07 14:29:54', '用户账号1', '123456', '用户姓名1', '男', '13823888881', 'upload/yonghu_touxiang1.jpg', 200);
INSERT INTO `yonghu` VALUES (12, '2024-03-07 14:29:54', '用户账号2', '123456', '用户姓名2', '男', '13823888882', 'upload/yonghu_touxiang2.jpg', 200);
INSERT INTO `yonghu` VALUES (13, '2024-03-07 14:29:54', '用户账号3', '123456', '用户姓名3', '男', '13823888883', 'upload/yonghu_touxiang3.jpg', 200);
INSERT INTO `yonghu` VALUES (14, '2024-03-07 14:29:54', '用户账号4', '123456', '用户姓名4', '男', '13823888884', 'upload/yonghu_touxiang4.jpg', 200);
INSERT INTO `yonghu` VALUES (15, '2024-03-07 14:29:54', '用户账号5', '123456', '用户姓名5', '男', '13823888885', 'upload/yonghu_touxiang5.jpg', 200);
INSERT INTO `yonghu` VALUES (16, '2024-03-07 14:29:54', '用户账号6', '123456', '用户姓名6', '男', '13823888886', 'upload/yonghu_touxiang6.jpg', 200);
INSERT INTO `yonghu` VALUES (17, '2024-03-07 14:29:54', '用户账号7', '123456', '用户姓名7', '男', '13823888887', 'upload/yonghu_touxiang7.jpg', 200);
INSERT INTO `yonghu` VALUES (18, '2024-03-07 14:29:54', '用户账号8', '123456', '用户姓名8', '男', '13823888888', 'upload/yonghu_touxiang8.jpg', 200);
