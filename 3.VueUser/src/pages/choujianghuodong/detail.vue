...
<div>
	<div :style='{"padding":"0","margin":"20px auto","borderColor":"#eee","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20240301/3bd53b03e3db41a8a75b2dad0cd5dacf.png) repeat-x left top / auto 8px","borderWidth":"0px","width":"80%","borderStyle":"solid","order":"3"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'☰'" :style='{"padding":"0 150px 0 120px","color":"#fff","background":"#f7c420","display":"inline-block","width":"auto","lineHeight":"50px","fontSize":"16px","justifyContent":"flex-start"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/choujianghuodong"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"padding":"0 10%","margin":"40px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"10px 0 0","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","order":"3"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"0px","margin":"0","background":"none","flex":"1","order":"2"}'>
				...
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动名称</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.huodongmingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动类型</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.huodongleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动状态</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.huodongzhuangtai}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动开始时间</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.huodongkaishishijian}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动结束时间</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.huodongjieshushijian}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#888","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}'>奖项设置</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#000","flex":"1","height":"auto"}'>{{detail.jiangxiangshezhi}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0 0 10px 0","borderColor":"#28890b10","borderRadius":"4px","background":"#fff","borderWidth":"0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="btn" :style='{"width":"100%","padding":"0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px 20px 0","outline":"none","color":"#fff","borderRadius":"6px","background":"#f7c420","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('choujianghuodong','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px 10px 0","color":"#333","borderRadius":"6px","background":"#ffecaf","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('choujianghuodong','删除')" @click="delClick">删除</el-button>
					<!-- hasChat 无 -->
					<!-- crossOptButtonStatusColumns [1] -->
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 10px 20px 0","color":"#fff","borderRadius":"6px","background":"#000","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('choujianghuodong','抽奖')" @click="onAcross('choujiangjilu','','','[1]','您的抽奖机会已用完！')" type="warning">{{isTimeInRange(detail.huodongkaishishijian,detail.huodongjieshushijian,getCurDateTime())}}</el-button>
				</div>
			</div>
		</div>
		...
		<el-tabs class="detail" :style='{"boxShadow":"none","margin":"20px auto 40px","borderColor":"#d8d8d8","background":"url(http://codegen.caihongy.cn/20240303/d773402b21c748ddbf4a9b7e093f7797.png) repeat-x center top / auto 10px","borderWidth":"0","display":"block","width":"100%","borderStyle":"solid","order":"8"}' v-model="activeName" type="border-card">
				...
				<div v-html="detail.huodongjieshao"></div>
			</el-tab-pane>
									</el-tabs>
	</div>
	...
	<el-dialog title="抽奖" :visible.sync="choujiangVisible" width="800px" :close-on-press-escape="false" :close-on-click-modal="false">
		<LuckyWheel ref="myLucky" width="600px" height="600px" :prizes="prizes" :blocks="blocks" :buttons="buttons"
			@start="startCallback" @end="endCallback" style="margin: 0 auto;" />
	</el-dialog>
	<el-dialog title="中奖结果" :visible.sync="raffleVisible" width="300px" :close-on-press-escape="false" :show-close="false" :close-on-click-modal="false" top="350px">
		<div style="padding: 40px 0;">
			<div style="width: 100%;text-align: center;font-size: 22px;font-weight: bold;color: #000;">{{raffleForm.type==1?'恭喜您中奖了！':'很遗憾，您未中奖'}}</div>
			<div style="width: 100%;text-align: center;font-size: 18px;font-weight: 500;color: #f00;margin: 40px 0 0;">{{raffleForm.text}}</div>
		</div>
	</el-dialog>
</div>
</template>
  ...
  export default {
    ...
    data() {
      return {
		...
		backgroundList: ['#ebd2fe','#e9e8fe','#b8c5f2'],
		prizes: [],
		buttons: [{
				radius: '40%',
				background: '#617df2'
    ...
    methods: {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              this.detail = res.data.data;
				if (res.data.data.jiangxiangshezhi) {
					let arr = res.data.data.jiangxiangshezhi.split(',')
					let brr = []
					for (let x in arr) {
						this.prizes.push({
							background: this.backgroundList[Number(x%3)],
							fonts: [{
								text: arr[x].split('|')[0]
							}],
							range: Number(arr[x].split('|')[1].split('%')[0])
						})
					}
				}
              this.title = this.detail.huodongbianhao;
      ...
      async onAcross(acrossTable,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
		if (acrossTable == 'choujiangjilu' && type == 1) {
			if (this.isTimeInRange(this.detail.huodongkaishishijian, this.detail.huodongjieshushijian, this
					.getCurDateTime()) != '抽奖') {
				return false
			}
			if (statusColumnName != '' && statusColumnName.startsWith("[")) {
				await this.$http.get(acrossTable + '/page', {
					params: {
						page: 1,
						limit: 10,
						crossrefid: this.detail.id,
						crossuserid: Number(localStorage.getItem('frontUserid'))
					}
				}).then(res => {
					if (res.data && res.data.code == 0) {
						let crossoptnum = JSON.parse(JSON.stringify(statusColumnName)).replace(/\[/,"").replace(/\]/, "");
		...
		if(acrossTable == 'choujiangjilu' && type == 2){
			localStorage.setItem('raffleType', true);
		}
        localStorage.setItem('crossTable',`choujianghuodong`);
		...
		endCallback(prize) {
			let type = 0
			this.detail.jiangpinmingcheng = prize.fonts[0].text
			for(let x in this.prizes){
				if(this.prizes[x].fonts[0].text==prize.fonts[0].text){
					if(x == (Number(this.prizes.length) - 1)){
						this.detail.shifouzhongjiang = '否'
						type = 0
						break
					}else {
						this.detail.shifouzhongjiang = '是'
						type = 1
						break
					}
				}
			...
			this.raffleForm = {
				text: this.detail.jiangpinmingcheng,
				type: type
			}
			setTimeout(()=>{
				this.raffleVisible = true
			},500)
			setTimeout(()=>{
				this.raffleVisible = false
				this.onAcross('choujiangjilu','','','[1]','您的抽奖机会已用完！','',2)
			},2500)
		},
		isTimeInRange(startTime, endTime, checkTime) {
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/choujianghuodongAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		delClick(){
			this.$confirm('是否删除此抽奖活动？')
			  .then(_ => {
			    this.$http.post('choujianghuodong/delete', [this.detail.id]).then(res => {
			      if (res.data.code == 0) {
			        this.$message({
			          type: 'success',
			          message: '删除成功!',
