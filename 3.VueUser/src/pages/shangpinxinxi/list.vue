...
<div>
	...
	<div v-if="centerType" :style='{"padding":"0","margin":"20px auto","borderColor":"#eee","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20240301/3bd53b03e3db41a8a75b2dad0cd5dacf.png) repeat-x left top / auto 8px","borderWidth":"0px","width":"80%","borderStyle":"solid","order":"3"}'>
		<el-button size="mini" @click="backClick">返回</el-button>
	</div>
	<div class="list-preview" :style='{"padding":"0 10%","margin":"0px auto","overflow":"hidden","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		

		<div class="category-3" :style='{"border":"0px solid #eee","padding":"0","boxShadow":"0px 0px 0px #eee","margin":"20px 20px 0 0","borderRadius":"12px","flexWrap":"wrap","background":"none","display":"flex","width":"200px","height":"auto","order":"5"}'>
			<div class="item" :class="swiperIndex == '-1' ? 'active' : ''" @click="getList(1, '全部')" :plain="isPlain">
				<div :style='{"color":"inherit","width":"auto","fontSize":"14px"}'>全部</div>
			</div>
			<div class="item" :class="swiperIndex == index ? 'active' : ''" v-for="(item, index) in fenlei" :key="index" @click="getList(1, item[feileiColumn], 'btn' + index)" :ref="'btn' + index" plain>
				<img v-if="item.image" :style='{"width":"50px","margin":"0 5px 0 0","objectFit":"cover","borderRadius":"4px","display":"block","height":"50px"}' :src="baseUrl + (item.image?item.image.split(',')[0]:'')">
				<div :style='{"color":"inherit","width":"auto","fontSize":"14px"}'>{{item[feileiColumn]}}</div>
			</div>
		</div>
	
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"12px 6px","margin":"0px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","borderRadius":"12px","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"0"}'>
      <el-form-item :style='{"margin":"0 10px 0"}'>
	  ...
	  <el-button v-if=" true " :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0px 10px 0 0px","color":"#fff","borderRadius":"4px","background":"#f7c420","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="getList(1, curFenlei)"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-search"></i>查询</el-button>
	  <el-button v-if="btnAuth('shangpinxinxi','新增')" :style='{"cursor":"pointer","border":"0px solid #ddd","padding":"0px 15px","margin":"0px 0px 0 0","color":"#fff","borderRadius":"4px","background":"#000","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/shangpinxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	<div class="select2" :style='{"border":"1px solid #f7c42060","padding":"10px 0","margin":"10px 0 0","background":"#fff","width":"100%","height":"auto","order":"2"}'>
	  <div :style='{"padding":"0 20px","margin":"4px 0","borderColor":"#eee","background":"none","borderWidth":"0 0 0px","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}' class="list" v-for="(item,index) in selectOptionsList" :key="item">
	...
	<div class="sort_view" :style='{"padding":"20px 20px 10px","margin":"26px 0 0","borderColor":"#f7c420","overflow":"hidden","borderRadius":"0px","textAlign":"center","background":"#fff","borderWidth":"0 0 4px","width":"calc(100% - 0px)","borderStyle":"solid","order":"3"}'>
		<el-button :style='{"padding":"4px 15px","margin":"0 5px","borderColor":"#28890b","borderRadius":"4px","background":"none","borderWidth":"0 0px 0 0","borderStyle":"solid"}' @click="sortClick('price')">
		...
		<el-button :style='{"border":"0","padding":"4px 15px","margin":"0 5px","borderRadius":"4px","background":"none"}' @click="sortClick('clicknum')">
	...
	<div class="list" :style='{"minHeight":"400px","padding":"20px 20px 0 0","margin":"0px 0 0","borderRadius":"0px","background":"#fff","flex":"1","width":"calc(100% - 220px)","order":"6"}'>
		...
		<div class="list3 index-pv1" :style='{"width":"100%","padding":"0 0px","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid #f6f6f6","width":"100%","padding":"0px","margin":"0","overflow":"hidden","height":"200px"}' class="img-box">
		    ...
		    <div :style='{"padding":"0 0px","overflow":"hidden","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0px 0 0","flexWrap":"wrap","display":"flex","order":"2"}'>
				<div class="title">{{item.shangpinmingcheng}}</div>
				<div class="title">{{item.shangpinleixing}}</div>
				<div v-if="item.price" class="price"><span :style='{"fontSize":"12px"}'>￥</span>{{item.price}}</div>
		        <div :style='{"width":"100%","padding":"2px 0px","borderColor":"#f0f0f0","borderStyle":"dashed","borderWidth":"0 0 0px 0"}' class="time">
		          <span class="icon iconfont icon-shijian21"></span>
		          <span class="text">{{item.addtime}}</span>
		        </div>
		        <div :style='{"padding":"2px 0px","borderColor":"#f0f0f0","margin":"0 10px 0 0","borderStyle":"dashed","borderWidth":"0 0 0px 0"}' class="publisher">
		          <span class="icon iconfont icon-geren16"></span>
		          <span class="text">{{item.dianpumingcheng}}</span>
		        </div>
		        <div :style='{"padding":"2px 0px","borderColor":"#eee","margin":"0 10px 0 0","borderStyle":"dashed","borderWidth":"0 0 0px 0"}' class="like">
		          <span class="icon iconfont icon-zan10"></span>
		          <span class="text">{{item.thumbsupnum}}</span>
		        </div>
		        <div :style='{"padding":"2px 0px","borderColor":"#eee","margin":"0 10px 0 0","borderStyle":"dashed","borderWidth":"0 0 0px 0"}' class="collect">
		          <span class="icon iconfont icon-shoucang10"></span>
		          <span class="text">{{item.storeupnum}}</span>
		        </div>
		        <div :style='{"padding":"2px 0px"}' class="view">
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
		this.$http.get('shangpinleixing/list',{}).then(res => {
		  if (res.data.code == 0) {
