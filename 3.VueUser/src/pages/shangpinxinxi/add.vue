...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="商品类型" prop="shangpinleixing">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="生产厂家" prop="shengchanchangjia">
            <el-input v-model="ruleForm.shengchanchangjia" 
                placeholder="生产厂家" clearable :disabled=" false  ||ro.shengchanchangjia"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="生产日期" prop="shengchanriqi">
              <el-date-picker
