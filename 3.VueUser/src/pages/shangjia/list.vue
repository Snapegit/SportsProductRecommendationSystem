...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"12px 6px","margin":"0px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","borderRadius":"12px","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"0"}'>
      <el-form-item :style='{"margin":"0 10px 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>店铺名称：</div>
	  ...
	  <el-button v-if="btnAuth('shangjia','新增')" :style='{"cursor":"pointer","border":"0px solid #ddd","padding":"0px 15px","margin":"0px 0px 0 0","color":"#fff","borderRadius":"4px","background":"#000","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/shangjiaAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
		...
		<div class="list3 index-pv1" :style='{"width":"100%","padding":"0 0px","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid #f6f6f6","width":"100%","padding":"0px","margin":"0","overflow":"hidden","height":"200px"}' class="img-box">
				<img @click.stop="imgPreView(item.dianpuzhaopian)" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-if="item.dianpuzhaopian && item.dianpuzhaopian.substr(0,4)=='http'" :src="item.dianpuzhaopian.split(',')[0]" class="image" />
				<img @click.stop="imgPreView(baseUrl + (item.dianpuzhaopian?item.dianpuzhaopian.split(',')[0]:''))" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-else :src="baseUrl + (item.dianpuzhaopian?item.dianpuzhaopian.split(',')[0]:'')" class="image" />
			</div>
		    <div :style='{"padding":"0 0px","overflow":"hidden","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0px 0 0","flexWrap":"wrap","display":"flex","order":"2"}'>
				<div class="title">{{item.dianpumingcheng}}</div>
				<div class="title">{{item.dianpudizhi}}</div>
		      ...
		      <div class="desc" v-html="item.dianpujianjie"></div>
		    </div>
		  </div>
		</div>
	</div>
